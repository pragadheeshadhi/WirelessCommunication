...
LOS = sqrt(K_factor/(K_factor + 1));
rician_channel = LOS + (randn(num_bits, 1) + 1i * randn(num_bits, 1)) /sqrt(2);
% Pass modulated signal through Rician fading channel
noisy_channel1=(modulated_signal.*rician_channel)
